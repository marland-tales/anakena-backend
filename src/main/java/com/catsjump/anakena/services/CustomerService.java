...
//instanciando cidade para ser usada no endereco
		Address adr = new Address(null, objDTO.getLogradouro(), objDTO.getNumero(), objDTO.getComplemento(),
				objDTO.getBairro(), objDTO.getCep(), ctm, cit);
//instanciando endereco (para instanciar a cidade eh necessario obter do banco de dados usando o codigo de cidade recebido na entrada no DTO
	...
	// o new.Obj que foi buscado no banco de dados no metodo mais acima, foram
	// atualizados para os novos valores fornecidos no obj
}